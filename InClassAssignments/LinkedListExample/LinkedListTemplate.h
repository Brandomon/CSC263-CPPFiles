#ifndef LINKEDLISTTEMPLATE_H_INCLUDED
#define LINKEDLISTTEMPLATE_H_INCLUDED
...
LinkedList<T>::~LinkedList()
{
    ListNode<T>* nodePtr;       //Used to traverse the list
    ListNode<T>* nextNode;      //Point to the next in the list
...
void LinkedList<T>::AppendNode(T value)
{
    ...
    if(head == nullptr) //Also can use if(!head)
    {
        head = tail = newNode;
    }
    else
...
void LinkedList<T>::InsertNode(T value)
{
    ...
    else
    {
        ...
        while(nodePtr != nullptr && nodePtr->value < value) //Order of arguments is important
        {
...
#endif // LINKEDLISTTEMPLATE_H_INCLUDED
